            ...
            {profile.map(({ firstname, lastname, team, position, jerseyNumber, height_feet, height_inches, weight, email }) => (
              <div key={email} className="w-2/3 py-4 mx-auto">
                <div className="flex justify-between">
                  ...
                  <div className="pt-8 pb-4 w-1/4">
                    <p className="font-medium text-xs md:text-md lg:text-lg text-gray-600 text-center">{team}</p>
                    <p className="font-medium text-xs md:text-md lg:text-lg text-gray-600 py-4 text-center">{position}</p>
                  </div>
                </div>
