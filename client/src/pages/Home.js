        ...
        <div className="flex flex-col-reverse md:flex-row justify-around">
          {transition.map(({ item, key, props }) =>
            ...
            <animated.div key={key} style={props} className="flex flex-col justify-evenly w-3/4 md:w-1/3 text-center md:text-left mx-auto">
              ...
              <p className="text-md md:text-xl lg:text-2xl md:-mt-4 lg:-mt-8 py-8 md:py-0">Record your stats, track your progress, share with your coaches and peers.</p>
              <div className="bg-white text-center w-min mx-auto rounded-full whitespace-nowrap hover:bg-gray-100 mb-4 md:mb-0">
